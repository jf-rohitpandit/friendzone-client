...
export const addFriend = (friendId) => async (dispatch) => {
  try {
    ...
    //axios logic
    await axios.put('https://friendzonee.herokuapp.com/friend', {
      friendId,
    })
...
export const getFriend = () => async (dispatch) => {
  try {
    ...
    const list = await axios.get('https://friendzonee.herokuapp.com/friend')
...
export const getSingleFriend = (id) => async (dispatch) => {
  try {
    ...
    const result = await axios.get(
      `https://friendzonee.herokuapp.com/friend/${id}`,
